...
\section{Experiences}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Led the design and development of a web-based caseload allocation tool, integrating a sophisticated many-to-many algorithm using Svelte, Tailwind, JavaScript, Go and Python}
