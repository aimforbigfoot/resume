...
\section{Experiences}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Virtual Reality (VR) Research Assistant}{July. 2021 -- Present}
      {York University}{Toronto, ON}
      \resumeItemListStart
        \resumeItem{Presented a poster on parsing object movement from movement environments created by self-motion in depth}
        \resumeItem{Working as a research assistant at Dr. Laurence R. Harris' Multi-sensory Laboratory}
        \resumeItem{Currently working on a VR depth perception project}
    \resumeItemListEnd
    
    \resumeSubheading
      {Managing Layout Editor of the Canadian Science Fair Journal}{Mar. 2020 -- Present}
      {Children’s Hospital of Eastern Ontario}{Ottawa, ON}
      \resumeItemListStart
        \resumeItem{Working with a team of 10+ layout editors under tight deadlines to produce multiple journal volumes}
        \resumeItem{Engineered an internal platform amalgamating features from Google Docs, Slack, and file management systems, resulting in a unified solution enhancing document accessibility, and workflow organization}
    \resumeItemListEnd
...
\hspace{2cm}
    ...
    \resumeSubheading
      ...
      {York University}{Toronto, ON}
      \resumeItemListStart
        \resumeItem{Held 8+ hours of office hours for students in BIOL 1000 to help understand concepts }
